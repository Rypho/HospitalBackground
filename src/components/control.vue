    ...
    <div id="left">
      ...
      <div id="menu">
        <el-menu>
          ...
          <router-link to="control"><el-menu-item class="liLevel" style="color: #3e99ff;font-size:11px;"><img src="../assets/pic/管理员1.png" class="img1" height="17" width="17"/>管理员管理</el-menu-item></router-link>
        </el-menu>
      </div>
    </div>
    <div id="top">
      ...
      <div id="t3"><img src="../assets/pic/退出.png" class="img2" height="18" width="18"/>退出登录</div>
    </div>
    <div id="content">
      <div id="tit">欢迎进入富阳妇幼保健院连续体温监护管理平台</div>
      <div id="logo" style="margin-top: 30px"><img src="../assets/pic/首页logo.png" height="240" width="420"/></div>
